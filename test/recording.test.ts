...
describe("recording upload/download API", () => {
  it("stores a posted recording and serves it back", async () => {
  ...
  it("rejects an empty upload and 404s an unknown recording", async () => {
  ...
  it("ignores path-traversal ids (sanitized to a safe filename)", async () => {
