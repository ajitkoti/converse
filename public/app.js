...
function analysisHtml(a) {
  ...
  const isLlm = a.generatedBy === "llm";
  const badge = `<span class="ai-badge ${isLlm ? "llm" : "offline"}" title="${isLlm ? "Generated by the AI model" : "Deterministic debrief from your call data — no AI key set, or the model was unavailable"}">${isLlm ? "✨ AI-generated" : "⚙️ from your call (no AI)"}</span>`;
  return `<div class="ai-debrief"><div class="ai-head"><h3>🧠 ${isLlm ? "AI deal debrief" : "Deal debrief"}</h3>${badge}` +
